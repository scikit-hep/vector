...
def test_isclose_spatial():
    ...
    v2_3d = vector.Array(
        [
            {"x": 1.0 + 1e-9, "y": 2.0 - 1e-9, "z": 3.0 + 1e-9},
            {"x": 4.0 - 1e-9, "y": 5.0 + 1e-9, "z": 6.0 - 1e-9},
        ]
    )
...
def test_isclose_planar():
    ...
    v2_2d = vector.Array(
        [
            {"x": 1.0 + 1e-9, "y": 2.0 - 1e-9},
            {"x": 4.0 - 1e-9, "y": 5.0 + 1e-9},
        ]
    )
