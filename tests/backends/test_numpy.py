...
def test_xy():
    array = vector._backends.numpy.VectorNumpy2D(
...
def test_pickle_momentum_numpy_2d():
    array = vector._backends.numpy.MomentumNumpy2D(
...
def test_pickle_vector_numpy_3d():
    array = vector._backends.numpy.VectorNumpy3D(
        [(0, 0, 0), (0, 1, 1), (3, 4, 5)],
...
def test_pickle_momentum_numpy_3d():
    array = vector._backends.numpy.MomentumNumpy3D(
        [(0, 0, 0), (0, 1, 1), (3, 4, 5)],
        dtype=[
            ("rho", numpy.float64),
            ("phi", numpy.float64),
...
def test_pickle_vector_numpy_4d():
    array = vector._backends.numpy.VectorNumpy4D(
...
def test_pickle_momentum_numpy_4d():
    array = vector._backends.numpy.MomentumNumpy4D(
        [(0, 0, 0, 0), (0, 1, 1, 1), (3, 4, 5, 6)],
        dtype=[
            ("rho", numpy.float64),
            ("phi", numpy.float64),
