...
def test_spatial_object():
    ...
    assert v1.deltaeta(v2) == pytest.approx(0.2674387219518324)
...
def test_spatial_numpy():
    ...
    assert v1.deltaeta(v2)[0] == pytest.approx(0.2674387219518324)
    ...
    for t1 in "xyz", "xytheta", "xyeta", "rhophiz", "rhophitheta", "rhophieta":
        for t2 in "xyz", "xytheta", "xyeta", "rhophiz", "rhophitheta", "rhophieta":
            ...
            assert tr1.deltaeta(tr2)[0] == pytest.approx(0.2674387219518324)
...
def test_lorentz_object():
    ...
    for t1 in (
        ...
        for t2 in (
            ...
            assert tr1.deltaeta(tr2) == pytest.approx(0.2674387219518324)
