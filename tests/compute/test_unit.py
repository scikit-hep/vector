...
def test_planar_object():
    v = vector.backends.object_.VectorObject2D(
...
def test_planar_numpy():
    v = vector.backends.numpy_.VectorNumpy2D(
        [(0.1, 0.2)],
...
def test_spatial_object():
    v = vector.backends.object_.VectorObject3D(
        vector.backends.object_.AzimuthalObjectXY(0.1, 0.2),
...
def test_spatial_numpy():
    v = vector.backends.numpy_.VectorNumpy3D(
        [(0.1, 0.2, 0.3)],
...
def test_lorentz_object():
    v = vector.backends.object_.VectorObject4D(
        vector.backends.object_.AzimuthalObjectXY(0.1, 0.2),
        vector.backends.object_.LongitudinalObjectZ(0.3),
...
def test_lorentz_numpy():
    v = vector.backends.numpy_.VectorNumpy4D(
        [(0.1, 0.2, 0.3, 0.4)],
        dtype=[
            ("x", numpy.float64),
            ("y", numpy.float64),
