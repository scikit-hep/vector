...
# Copied from https://en.wikipedia.org/wiki/Euler_angles#Rotation_matrix


def cartesian_xzx(lib, psi, theta, phi, x, y, z):
    c1 = lib.cos(psi)
    s1 = lib.sin(psi)
    c2 = lib.cos(theta)
    s2 = lib.sin(theta)
...
def cartesian_xyx(lib, psi, theta, phi, x, y, z):
    c1 = lib.cos(psi)
    s1 = lib.sin(psi)
    c2 = lib.cos(theta)
    s2 = lib.sin(theta)
...
def cartesian_yxy(lib, psi, theta, phi, x, y, z):
    c1 = lib.cos(psi)
    s1 = lib.sin(psi)
    c2 = lib.cos(theta)
    s2 = lib.sin(theta)
...
def cartesian_yzy(lib, psi, theta, phi, x, y, z):
    c1 = lib.cos(psi)
    s1 = lib.sin(psi)
    c2 = lib.cos(theta)
    s2 = lib.sin(theta)
...
def cartesian_zyz(lib, psi, theta, phi, x, y, z):
    c1 = lib.cos(psi)
    s1 = lib.sin(psi)
    c2 = lib.cos(theta)
    s2 = lib.sin(theta)
...
def cartesian_zxz(lib, psi, theta, phi, x, y, z):
    c1 = lib.cos(psi)
    s1 = lib.sin(psi)
    c2 = lib.cos(theta)
    s2 = lib.sin(theta)
...
def cartesian_xzy(lib, psi, theta, phi, x, y, z):
    c1 = lib.cos(psi)
    s1 = lib.sin(psi)
    c2 = lib.cos(theta)
    s2 = lib.sin(theta)
...
def cartesian_xyz(lib, psi, theta, phi, x, y, z):
    c1 = lib.cos(psi)
    s1 = lib.sin(psi)
    c2 = lib.cos(theta)
    s2 = lib.sin(theta)
...
def cartesian_yxz(lib, psi, theta, phi, x, y, z):
    c1 = lib.cos(psi)
    s1 = lib.sin(psi)
    c2 = lib.cos(theta)
    s2 = lib.sin(theta)
...
def cartesian_yzx(lib, psi, theta, phi, x, y, z):
    c1 = lib.cos(psi)
    s1 = lib.sin(psi)
    c2 = lib.cos(theta)
    s2 = lib.sin(theta)
...
def cartesian_zyx(lib, psi, theta, phi, x, y, z):
    c1 = lib.cos(psi)
    s1 = lib.sin(psi)
    c2 = lib.cos(theta)
    s2 = lib.sin(theta)
...
def cartesian_zxy(lib, psi, theta, phi, x, y, z):
    c1 = lib.cos(psi)
    s1 = lib.sin(psi)
    c2 = lib.cos(theta)
    s2 = lib.sin(theta)
...
def make_conversion(azimuthal, longitudinal, order):
    if (azimuthal, longitudinal) != (AzimuthalXY, LongitudinalZ):
        ...
        def f(lib, psi, theta, phi, coord1, coord2, coord3):
            return cartesian(lib, psi, theta, phi, to_x(coord1, coord2), to_y(coord1, coord2), to_z(coord1, coord2, coord3))
...
def dispatch(psi, theta, phi, order, v):
    ...
    with numpy.errstate(all="ignore"):
        return v._wrap_result(
            function(v.lib, psi, theta, phi, *v.azimuthal.elements, *v.longitudinal.elements),
            returns,
        )
