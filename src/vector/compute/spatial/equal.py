...
from vector.compute.spatial import eta, z
...
def xy_theta_xy_eta(lib, x1, y1, theta1, x2, y2, eta2):
    return xy_eta_xy_eta(lib, x1, y1, eta.xy_theta(lib, x1, y1, theta1), x2, y2, eta2)
...
def xy_eta_xy_theta(lib, x1, y1, eta1, x2, y2, theta2):
    return xy_eta_xy_eta(lib, x1, y1, eta1, x2, y2, eta.xy_theta(lib, x2, y2, theta2))
...
def xy_eta_rhophi_eta(lib, x1, y1, eta1, rho2, phi2, eta2):
    return xy_eta_xy_eta(
        lib, x1, y1, eta1, x.rhophi(lib, rho2, phi2), y.rhophi(lib, rho2, phi2), eta2
    )
...
def rhophi_theta_rhophi_eta(lib, rho1, phi1, theta1, rho2, phi2, eta2):
    return rhophi_eta_rhophi_eta(
        lib, rho1, phi1, eta.rhophi_theta(lib, rho1, phi1, theta1), rho2, phi2, eta2
    )
...
def rhophi_eta_xy_eta(lib, rho1, phi1, eta1, x2, y2, eta2):
    return xy_eta_xy_eta(
        lib, x.rhophi(lib, rho1, phi1), y.rhophi(lib, rho1, phi1), eta1, x2, y2, eta2
    )


def rhophi_eta_rhophi_z(lib, rho1, phi1, eta1, rho2, phi2, z2):
    return rhophi_z_rhophi_z(
        lib, rho1, phi1, z.rhophi_eta(lib, rho1, phi1, eta1), rho2, phi2, z2
    )


def rhophi_eta_rhophi_theta(lib, rho1, phi1, eta1, rho2, phi2, theta2):
    return rhophi_eta_rhophi_eta(
        lib, rho1, phi1, eta1, rho2, phi2, eta.rhophi_theta(lib, rho2, phi2, theta2)
    )
