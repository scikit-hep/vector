...
from vector._compute.spatial import add
...
dispatch_map: dict[
    ...
    tuple[
        typing.Callable[
            ...
            tuple[
                ScalarCollection, ScalarCollection, ScalarCollection, ScalarCollection
            ],
        ],
        type[Azimuthal],
        type[Longitudinal],
...
def make_conversion(
    ...
    spatial_add, azimuthal, longitudinal = add.dispatch_map[
