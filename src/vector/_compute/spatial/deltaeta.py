...
def xy_z_xy_z(lib, x1, y1, z1, x2, y2, z2):
    return eta.xy_z(lib, x1, y1, z1) - eta.xy_z(lib, x2, y2, z2)
...
def xy_z_rhophi_theta(lib, x1, y1, z1, rho2, phi2, theta2):
    return eta.xy_z(lib, x1, y1, z1) - eta.rhophi_theta(lib, rho2, phi2, theta2)
...
def xy_theta_xy_theta(lib, x1, y1, theta1, x2, y2, theta2):
    return eta.xy_theta(lib, x1, y1, theta1) - eta.xy_theta(lib, x2, y2, theta2)
...
def xy_theta_rhophi_theta(lib, x1, y1, theta1, rho2, phi2, theta2):
    return eta.xy_theta(lib, x1, y1, theta1) - eta.rhophi_theta(lib, rho2, phi2, theta2)
...
def xy_eta_rhophi_z(lib, x1, y1, eta1, rho2, phi2, z2):
    return eta1 - eta.rhophi_z(lib, rho2, phi2, z2)
...
def rhophi_z_xy_eta(lib, rho1, phi1, z1, x2, y2, eta2):
    return eta.rhophi_z(lib, rho1, phi1, z1) - eta2


def rhophi_z_rhophi_z(lib, rho1, phi1, z1, rho2, phi2, z2):
    return eta.rhophi_z(lib, rho1, phi1, z1) - eta.rhophi_z(lib, rho2, phi2, z2)


def rhophi_z_rhophi_theta(lib, rho1, phi1, z1, rho2, phi2, theta2):
    return eta.rhophi_z(lib, rho1, phi1, z1) - eta.rhophi_theta(lib, rho2, phi2, theta2)
...
def rhophi_theta_xy_z(lib, rho1, phi1, theta1, x2, y2, z2):
    return eta.rhophi_theta(lib, rho1, phi1, theta1) - eta.xy_z(lib, x2, y2, z2)


def rhophi_theta_xy_theta(lib, rho1, phi1, theta1, x2, y2, theta2):
    return eta.rhophi_theta(lib, rho1, phi1, theta1) - eta.xy_theta(lib, x2, y2, theta2)
...
def rhophi_theta_rhophi_z(lib, rho1, phi1, theta1, rho2, phi2, z2):
    return eta.rhophi_theta(lib, rho1, phi1, theta1) - eta.rhophi_z(lib, rho2, phi2, z2)
